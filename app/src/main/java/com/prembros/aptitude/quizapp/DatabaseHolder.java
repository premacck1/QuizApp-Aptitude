...
//    public static final String databaseName = "quizDatabase";
    ...
    public static final String Table_Create = "create table if not exists QuizTable (field text not null, section text not null,question text not null, option1 text not null, option2 text not null, option3 text not null, option4 text not null, answer text not null);";
    ...
    public Cursor returnData() {
        return db.query(tableName, new String[] {field,section,question,option1,option2,option3,option4,answer}, null, null, null, null, null);
    }
