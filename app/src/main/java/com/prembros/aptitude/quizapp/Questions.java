...
public class Questions extends Fragment implements OnClickListener, OnLongClickListener {
    ...
    static String SECTION_ARG = "sectionSelection";
...
//        GET THE SELECTED FIELD AND SECTION.
        Bundle b = this.getArguments();
        selections = new String[]{String.valueOf(b.get(FIELD_ARG)), String.valueOf(b.get(SECTION_ARG))};

//        GET THE QUESTIONS CORRESPONDING TO THE SELECTED FIELD AND SECTION
...
//            Setting the total time according to section. Higher the section, less the total time.
            switch (selections[1]){
                case "Rookie":
...
//        showInterstitial3();
    ...
    public void onBackPressed() {
        ...
        switch (Section.BACK_FROM_RESULTS){
